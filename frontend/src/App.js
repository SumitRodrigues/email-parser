...
const API_BASE_URL =
  process.env.REACT_APP_API_URL || "https://email-parser-backend.onrender.com";
        ...
        <div className="space-y-6">
          <section>
            ...
            <p className="text-gray-300">
              We collect email addresses solely for the purpose of name
              extraction. No personal data is stored permanently on our servers.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-300">
              Extracted names are processed in real-time and immediately
              discarded after generating the requested output. We never share
          ...
          <section>
            ...
            <p className="text-gray-300">
              We use LinkedIn API for profile validation. Their privacy policy
              can be found at{" "}
              <a
  ...
  const processLinkedIn = async () => {
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/api/process-linkedin`,
        {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10 p-6">
            ...
            {error && (
              <div
                className="mt-6 p-4 bg-red-950/50 border border-red-500 rounded-lg 
        ...
        <footer className="mt-12 border-t-2 border-red-900/50">
          <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2">
                  <li>
                    <a
                      href="https://github.com/SumitRodrigues"
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/sumit-rodrigues/"
                      className="text-gray-400 hover:text-red-400 transition-colors"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
              ...
              <div className="space-y-4">
                ...
                <p className="text-red-400 text-sm">sumitrod11@gmail.com</p>
            ...
            <div className="mt-8 pt-8 border-t border-red-900/50 text-center">
              <p className="text-gray-400 text-sm">
                &copy; {new Date().getFullYear()} Email Name Extractor. All
                rights reserved.
              </p>
            </div>
          </div>
